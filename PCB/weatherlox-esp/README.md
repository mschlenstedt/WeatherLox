...
![PCB for ESP32 TOP](./pictures/top.svg =200%)

![PCB for ESP32 Bottom](./pictures/bottom.svg =200%)

The breadboard looks like this:

![Breadboard for ESP32 Bottom](./pictures/weatherlox-esp-pcb_Steckplatine.png)
