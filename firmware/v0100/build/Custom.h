...
#define FEATURE_OPENMETEO_EVENT         1  // Generates an event with the response of a open-meteo request (https://open-meteo.com/en/docs)
#define FEATURE_JSON_EVENT              1  // Generates an event with the values of a JSON repsonse of an HTTP call. Keys are stored in json.keys one key per line (e.g.: Body.Data.DAY_ENERGY.Values.1)
...
#define BUILD_GIT           "WeatherLox Build: "  __DATE__ " "  __TIME__


#define DEFAULT_NAME        "weatherlox"                        // Enter your device friendly name
...
#define DEFAULT_AP_KEY      "weatherlox"                             // Enter network WPA key for AP (config) mode
...
#define DEFAULT_ADMIN_USERNAME               "weatherlox"
#define DEFAULT_ADMIN_PASS                   "weatherlox"
...
#endif
#ifdef ESP32
#define DEFAULT_PIN_I2C_SDA                     21                // D21
#endif
#ifdef ESP8266
#define DEFAULT_PIN_I2C_SCL                     5
#endif
#ifdef ESP32
#define DEFAULT_PIN_I2C_SCL                     22                // D22
#endif
#define DEFAULT_I2C_CLOCK_SPEED                 100000            // Use 100 kHz if working with old I2C chips
...
#define DEFAULT_MQTT_LWT_CONNECT_MESSAGE        "running"                   // Default LWT messages if connected
#define DEFAULT_MQTT_LWT_DISCONNECT_MESSAGE     "stopped"                   // Default LWT messages if disconnected
#define DEFAULT_MQTT_USE_UNITNAME_AS_CLIENTID   0

#define DEFAULT_USE_NTP                         true             // (true|false) Use NTP Server
#define DEFAULT_NTP_HOST                        "de.pool.ntp.org"                // NTP Server Hostname
...
#define CUSTOM_EMERGENCY_FALLBACK_START_AP           true
...
#endif // ifdef ESP8266
# ifdef ESP32
#  define PLUGIN_STATS_NR_ELEMENTS 185
#endif // ifdef ESP32
...
#define FEATURE_I2C_DEVICE_CHECK 1 // Disable the I2C Device check feature
...
//  #define DEFAULT_FACTORY_DEFAULT_DEVICE_MODEL  0 // DeviceModel_default
// #endif
#define DEFAULT_PROVISIONING_FETCH_RULES1      true
#define DEFAULT_PROVISIONING_FETCH_RULES2      true
#define DEFAULT_PROVISIONING_FETCH_RULES3      true
#define DEFAULT_PROVISIONING_FETCH_RULES4      true
#define DEFAULT_PROVISIONING_FETCH_NOTIFICATIONS true
#define DEFAULT_PROVISIONING_FETCH_SECURITY     true
#define DEFAULT_PROVISIONING_FETCH_CONFIG       true
#define DEFAULT_PROVISIONING_FETCH_PROVISIONING true
#define DEFAULT_PROVISIONING_FETCH_FIRMWARE     true
...
// #define FEATURE_EXTENDED_TASK_VALUE_TYPES 1               // 0 = Disable extra task value types like 64 bit ints, double, etc. in Dummy tasks
